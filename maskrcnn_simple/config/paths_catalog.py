...
class DatasetCatalog(object):
    DATA_DIR = "datasets"  # all data dir

    # datasets img dir and annotation file
    DATASETS = {
        "coco_2014_train": {
    ...
    def get(name):
        if "coco" in name:
            data_dir = DatasetCatalog.DATA_DIR  # datasets is the dataset root dir
            attrs = DatasetCatalog.DATASETS[name]
            # coco use img_dir and ann_file
            args = dict(
